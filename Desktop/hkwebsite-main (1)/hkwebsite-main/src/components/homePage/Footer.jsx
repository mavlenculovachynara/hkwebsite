...
const Footer = () => {
  return (
    <footer style={{ backgroundColor: '#212123', color: 'white', padding: '40px 0' }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={3}>
                <div className="links social-icon-item">
                  ...
                  {/* БЛОК */}
                  <IconButton href="" target="_blank" style={{ color: '#212123' }}>
                    <FacebookIcon fontSize="large" />
                  </IconButton>
              ...
              <Grid item xs={3}>
                ...
                <IconButton href="" target="_blank" style={{ color: '#212123' }}>
                  ...
                  <Typography variant="body2" color={'#212123'}>Facebook</Typography>
                  {/*БЛОК  */}
